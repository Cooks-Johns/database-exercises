...
-------------->     this will place everying on one line
...
SELECT datediff(curdate(),hire_date) / 365, hire_date
FROM employees
WHERE hire_date BETWEEN '1990-01-01' AND '1999-12-31'
AND birth_date LIKE '%-12-25'
ORDER BY birth_date, hire_date DESC
...
--[FINAL THIS IS WHAT YOU WOULD TURN IN

SELECT CONCAT_WS(' ', datediff(curdate(), hire_date),
      ' days.') AS DAYSWORKED
FROM employees
WHERE hire_date BETWEEN '1990-01-01' AND '1999-12-31'
AND birth_date LIKE '%-12-25'
